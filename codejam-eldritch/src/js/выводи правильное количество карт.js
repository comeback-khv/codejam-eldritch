        ...
        if (greenCardDataClone.length < sumOfGreenEasyCards) {
            for (let j = 0; j < greenCardData.length - 1; j++) {
                if (greenCardDataClone.length < sumOfGreenEasyCards) {
                    ...
                    if (greenCardData[rndNum].difficulty === 'normal') {
                        greenCardDataClone.push(greenCardData[rndNum])
                    }
                }
            }
        }
        ...
        if (brownCardDataClone.length < sumOfBrownEasyCards) {
            for (let j = 0; j < brownCardData.length - 1; j++) {
                if (brownCardDataClone.length < sumOfBrownEasyCards) {
                    ...
                    if (brownCardData[rndNum].difficulty === 'normal') {
                        brownCardDataClone.push(brownCardData[rndNum])
                    }
                }
            }
        }
        ...
        if (blueCardDataClone.length < sumOfBlueEasyCards) {
            for (let j = 0; j < brownCardData.length - 1; j++) {
                if (blueCardDataClone.length < sumOfBlueEasyCards) {
                    ...
                    if (blueCardData[rndNum].difficulty === 'normal') {
                        blueCardDataClone.push(blueCardData[rndNum])
                    }
                }
            }
        }
