...
let greenCardDataCloneSuperEasy = []
for (let j = 0; j < greenCardData.length - 1; j++) {
    greenCardDataCloneSuperEasy.push(greenCardData[j])
}
let brownCardDataCloneSuperEasy = []
for (let j = 0; j < brownCardData.length - 1; j++) {
    brownCardDataCloneSuperEasy.push(brownCardData[j])
}
let blueCardDataCloneSuperEasy = []
for (let j = 0; j < blueCardData.length - 1; j++) {
    blueCardDataCloneSuperEasy.push(blueCardData[j])
}
...
function pickAncient(heroNumber, difficulty) {
    ...
    if (difficulty === 'superEasy') {
        ...
        if (greenCardDataClone.length < sumOfGreenEasyCards) {
            for (let j = 0; j < greenCardData.length - 1; j++) {
                if (greenCardDataClone.length < sumOfGreenEasyCards) {
                    rndNum = randomNumber(greenCardDataCloneSuperEasy.length - 1 - j);
                    if (greenCardDataCloneSuperEasy[rndNum].difficulty === 'normal') {
                        greenCardDataClone.push(greenCardDataCloneSuperEasy[rndNum]);
                        greenCardDataCloneSuperEasy.slice(rndNum, 1);
                    }
                }
            }
        }
        ...
        if (brownCardDataClone.length < sumOfBrownEasyCards) {
            for (let j = 0; j < brownCardData.length - 1; j++) {
                if (brownCardDataClone.length < sumOfGreenEasyCards) {
                    rndNum = randomNumber(brownCardDataCloneSuperEasy.length - 1 - j);
                    if (brownCardDataCloneSuperEasy[rndNum].difficulty === 'normal') {
                        brownCardDataClone.push(brownCardDataCloneSuperEasy[rndNum]);
                        brownCardDataCloneSuperEasy.slice(rndNum, 1);
        ...
        if (blueCardDataClone.length < sumOfBlueEasyCards) {
            for (let j = 0; j < blueCardData.length - 1; j++) {
                if (blueCardDataClone.length < sumOfBlueEasyCards) {
                    rndNum = randomNumber(blueCardDataCloneSuperEasy.length - 1 - j);
                    if (blueCardDataCloneSuperEasy[rndNum].difficulty === 'normal') {
                        blueCardDataClone.push(blueCardDataCloneSuperEasy[rndNum]);
                        blueCardDataCloneSuperEasy.slice(rndNum, 1);
                    }
                }
            }
        }
