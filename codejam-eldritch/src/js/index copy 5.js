...
function pickAncient(heroNumber, difficulty) {
    ...
    if (difficulty === 'superEasy') {
        ...
        if (greenCardDataClone.length < sumOfGreenEasyCards) {
            for (let j = 0; j < greenCardData.length - 1; j++) {
                if (greenCardDataClone.length < sumOfGreenEasyCards) {
                    rndNum = randomNumber(greenCardData.length - 1 - j);
                    let rndDiff = greenCardData[rndNum]
                    if (rndDiff.difficulty === 'normal') {
                        greenCardDataClone.push(rndDiff)
                        greenCardData.splice(rndNum, 1);
                    }
                }
            }
        }
        ...
        if (brownCardDataClone.length < sumOfBrownEasyCards) {
            for (let j = 0; j < brownCardData.length - 1; j++) {
                if (brownCardDataClone.length < sumOfBrownEasyCards) {
                    rndNum = randomNumber(brownCardData.length - 1 - j);
                    let rndDiff = brownCardData[rndNum]
                    if (rndDiff.difficulty === 'normal') {
                        brownCardDataClone.push(rndDiff)
                        brownCardData.splice(rndNum, 1);
                        console.log(rndDiff.difficulty)
                    }
                }
            }
        }
       ...
       //             let rndDiff = brownCardDataCloneSuperEasy[rndNum]
       //             if (rndDiff.difficulty === 'normal') {
       //                 brownCardDataClone.push(rndDiff)
       //                 brownCardDataCloneSuperEasy.splice(rndNum, 1);
       //                 console.log(rndDiff.difficulty)
       //             }
       //         }
       //     }
       // }
        ...
        if (blueCardDataClone.length < sumOfBlueEasyCards) {
            for (let j = 0; j < blueCardData.length - 1; j++) {
                if (blueCardDataClone.length < sumOfBlueEasyCards) {
                    rndNum = randomNumber(blueCardData.length - 1 - j);
                    let rndDiff = blueCardData[rndNum]
                    if (rndDiff.difficulty === 'normal') {
                        blueCardDataClone.push(rndDiff)
                        blueCardData.splice(rndNum, 1);
                    }
                }
            }
        }
    }
    console.log(sumOfBlueEasyCards)
